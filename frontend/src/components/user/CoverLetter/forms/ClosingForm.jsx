    ...
    <div className="form-section p-4">
      ...
      <div className="signature-preview">
        ...
        <div className="signature-box">
          ...
          {formData.email && (
            <p className="signature-detail">{formData.email}</p>
          )}
          {formData.phone && (
            <p className="signature-detail">{formData.phone}</p>
          )}
          {formData.linkedin && (
            <p className="signature-detail">{formData.linkedin}</p>
          )}
        </div>
      </div>
      ...
      <div className="closing-tips">
        ...
        <ul>
          <li>
            <strong>Be professional:</strong> Stick to traditional closings for
            formal applications
          </li>
          <li>
            <strong>Match the tone:</strong> Your closing should match the
            overall tone of your letter
          </li>
          <li>
            <strong>Include contact info:</strong> Make it easy for employers to
            reach you
          </li>
          <li>
            <strong>Proofread:</strong> Double-check spelling of your name and
            contact details
          </li>
        </ul>
      </div>
